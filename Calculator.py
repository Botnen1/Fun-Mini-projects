...
def cal():
    ...
    cal_button_bg = '#4b5320'
    num_button_bg = '#4B4B4B'
    other_button_bg = '#DDDDDD'
    
    button_active_bg = '#C0C0C0'

    num_button = partial(Button, root, fg="black", bg=num_button_bg,
                         padx=10, pady=3, activebackground=button_active_bg)
    cal_button = partial(Button, root, fg="black", bg=cal_button_bg,
                         padx=10, pady=3, activebackground=button_active_bg)
    ...
    button14 = Button(root, text='/', fg="black", bg=cal_button_bg, padx=10, pady=3,
    ...
    button17 = Button(root, text='=', fg="black", bg=cal_button_bg, padx=10, pady=3,
                      command=lambda: calc(entry), activebackground=button_active_bg)
    button17.grid(row=5, column=3, pady=5)

    button18 = Button(root, text='^', fg="black", bg=cal_button_bg, padx=10, pady=3,
                      command=lambda: get_input(entry, '**'))
